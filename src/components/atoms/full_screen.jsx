  ...
  return (
    <div className='header_button'>
        ...
        <div className="fullscreen" >
          ...
          >
            <img className="full_screen_img" alt="" src={isFullScreen ? logoData.full_screen_icon_after : logoData.full_screen_icon}  style={{ height: 20, padding:'5px 5px', filter: "brightness(0) invert(1)" }} />
          </Button>
        </div>
    </div>
  );
