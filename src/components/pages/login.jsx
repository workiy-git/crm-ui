...
function Loginpage() {
  ...
  const handleLogin = async (event, retry = false) => {
    event.preventDefault();
            ...
            <div className="login-right-section">
              <div className="login-right-section-main">
                ...
                <Grid className="Login-input">
                  <Grid item xs={12} sm={6} className="login-form-group">
                    <div className="login-align-items">
                      <Typography className="login-lable">
                        {companylogoData.company.lable}
                      </Typography>
                      <input
                        type="text"
                  ...
                  <Grid item xs={12} sm={6} className="login-form-group">
                    <div className="login-align-items">
                      <Typography className="login-lable">
                        {companylogoData.username.lable}
                      </Typography>
                      <input
                        type="text"
                        className="login-text-field"
                  ...
                  <Grid item xs={12} className="login-form-group">
                    <div className="login-align-items">
                      <Typography className="login-lable">
                        {companylogoData.password.lable}
                      </Typography>
                ...
                <div className="login-center login-submit-block">
                  <a className="login-forgot-password" href="/forget-password">
