import "../../assets/styles/landingcss/landing.css";
...
const LandingPage = () => {
  ...
  const handleClick = () => {
    // Navigate to the 'todaycalls' route when the button is clicked
    navigate('/todaycalls');
  };
  ...
  return (
    ...
    {landingpage.map((item) => (
      ...
      <div>
        <button  className="day-in-button">Dayin</button>
      </div>
      ...
      <button className="reload-button">
        { <img className="full-screen-icon" src={`data:image/jpg;base64, ${item.reload_img}`} alt="banner_img" /> }
      </button>
      ...
      <div className="component-2">
        <div className="calls2">
          { <img className="edit-image-icon" src={`data:image/jpg;base64, ${item.dphone_img}`} alt="banner_img" /> }
        </div>
      ...
      <button className="all-call">
        ...
        <button className="today-calls" onClick={handleClick}>
